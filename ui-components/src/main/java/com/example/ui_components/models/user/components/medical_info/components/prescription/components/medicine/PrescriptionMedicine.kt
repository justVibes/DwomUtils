package com.example.ui_components.models.user.components.medical_info.components.prescription.components.medicine
...
data class PrescriptionMedicine(
    ...
    companion object {
        fun mapToLocal(form: PrescriptionMedicine) = LocalPrescriptionMedicine()
            .apply {
