...
val HeartRateColor = Color(0xFFFF69B4)
val RespiratoryRateColor = Color(0xFF00BFFF)
val BloodPressureColor = Color(0xFF032B44)
val BloodOxygenColor = Color(0xFF32CD32)
val BodyTemperatureColor = Color(0xFFFFFF00)